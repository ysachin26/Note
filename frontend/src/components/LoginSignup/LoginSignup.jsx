                    ...
                    {isLogin === 'Login' ?
                        ...
                        <>
                            ...
                            {/* {isLogin === 'Login' ? <div></div> : <div className="bg-white rounded-sm w-60 h-10 mb-5">
                                ...
                                <input value={name} onChange={(e) => setName(e.target.value)} className="h-10 w-60 focus:outline-none border-2 rounded-md " placeholder="full name" type="text" />
                            </div>} */}

                            <div className="bg-white rounded-sm w-60 h-10">
                                <label className="" htmlFor="email"></label>
                                <input value={email} onChange={(e) => setEmail(e.target.value)} className="h-10 w-60 focus:outline-none border-2 rounded-md " placeholder="email" type="email" />
                            </div>
